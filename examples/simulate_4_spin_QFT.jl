...
function run_example()
    ...
    set_coupling!(base_system, 4, 1, 0.3)  # Fixed coupling
    set_coupling!(base_system, 2, 3, 0.3)
    set_coupling!(base_system, 3, 4, 0.3) # Fixed coupling
    set_chemical_shift!(base_system, 1, 0.5) # Fixed shift
    set_chemical_shift!(base_system, 2, 0.5) # Fixed shift
    set_chemical_shift!(base_system, 3, 0.5) # Fixed shift
